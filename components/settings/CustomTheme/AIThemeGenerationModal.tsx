...
import { shallowEqual, useDidUpdate, useInputState, useListState } from '@mantine/hooks';
    ...
    <Modal className='cursor-default' centered open={open} onClose={onClose}>
      <div className='max-w-sm flex flex-col gap-3.5 text-sm'>
        ...
        <div className='flex flex-col gap-3'>
          <Input error={!name && 'Name is required'} label='name' value={name} onChange={setName} />
          ...
          <Button
            ...
            onClick={() => {
              ...
              const colors: ThemeColors = {
                ...
                text: palette[4],
                error: palette[5],
                errorExtra: (errorColor.isDark()
                  ? errorColor.lighten(0.2)
                  : errorColor.darken(0.2)
                ).toHex(),
